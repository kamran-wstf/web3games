      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {stats.map((stat, index) => (
            <div key={index} className="bg-slate-800/80 rounded-2xl p-8 text-center hover:bg-slate-800 transition-all border border-slate-700/50 hover:border-emerald-500/30">
              <div className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-slate-700/50 mb-6 ${stat.color}`}>
